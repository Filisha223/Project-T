        ...
        private _ Avatar = () => Behav()
            .Init("shtrs Defense System",
                new State(
                    ...
                    new ChangeGroundOnDeath(new[] { "Pure Evil" }, new[] { "shtrs Disaster Floor", "shtrs Sha ttered Floor" },
                    30),
                    new State("stars",
                        new Taunt("BURN!!"),
                    ...
                    new MostDamagers(30,
                     new ItemLoot("Tablet of the King's Avatar", 0.03),
                     new ItemLoot("UnShadowed Armor", 0.03),
