    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        protected override void ExportStats(IDictionary<StatsType, object> stats)
        {
            ...
            if (Boost != null)
            {
                ...
                stats[StatsType.Attack] = Stats[2] + Boost[2] + Adding1() + Adding2() + Adding3() + Adding4() + Adding5() + Adding6() + LE1Ability();
                ...
                stats[StatsType.Vitality] = Stats[5] + Health24() + Boost[5] + Adding1() + Adding2() + Adding3() + Adding4() + Adding5() + Adding6() + LE1Ability();
                ...
                stats[StatsType.HPBoost] = Boost[0] + LE1Ability();
                stats[StatsType.MPBoost] = Boost[1] + LE1Ability();
                stats[StatsType.AttackBonus] = Boost[2] + Adding1() + Adding2() + Adding3() + Adding4() + Adding5() + Adding6() + LE1Ability();
                ...
                stats[StatsType.VitalityBonus] = Boost[5] + Health24() + Adding1() + Adding2() + Adding3() + Adding4() + Adding5() + Adding6() + LE1Ability();
        ...
        private void AnnounceDeath(string killer)
        {
            ...
            var AccID = Client.Account.AccountId;
            var CharID = Client.Character.CharacterId;

            foreach (var w in Manager.Worlds.Values)
                foreach (var p in w.Players.Values)
                    p.SendError(Name + " died at level: " + Level + " Killed by: " + killer + " Fame: " + Fame + " Maxed: " + maxstat + " CharacterID: " + CharID + " AccountID: " + AccID + ".");
        }
        ...
        public void Teleport(RealmTime time, TeleportPacket packet)
        {
            ...
            try
            {
                ...
                else if (!CheckTeleportLowHp() || HP >= MaxHp / 2)
                {
                    ApplyConditionEffect(new ConditionEffect
                    {
                        Effect = ConditionEffectIndex.Damaging,
